...
function tiempo(){
	if(numerowidth>=1024) {numerowidth=0}else{numerowidth+=5}
		for (var i = 0; i <= numerowidth; i+=12) {
			if(numerowidth>=i) {ubicacionx=i}
		}
	if(numero1>=1024) {numero1=0}else{numero1+=5}
...
ctx.drawImage(sprite,ubicacionx,0,500,500,ubicacion1,400,100,100);
frame(tiempo);
}
